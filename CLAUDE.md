...
This project is indexed by GitNexus as **nas_agent** (3255 symbols, 5264 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
