...
This project is indexed by GitNexus as **nas_agent** (4635 symbols, 7111 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
