...
This project is indexed by GitNexus as **nas_agent** (5079 symbols, 7692 relationships, 134 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
