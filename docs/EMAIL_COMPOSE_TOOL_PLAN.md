...
KORISNIK: pregleda i sam klikće "Send"
```
...
5. Korisnik klikće "Ubaci u email" (ili glasovna komanda "Pošalji u email")
...
10. Korisnik prelazi u Outlook i sam klikće Send
```
...
# 2. email_compose NIKAD ne klikće Send — tool se uvijek zaustavlja prije
