...
NOT YET wired into the tool registry (Faza B, per the plan's phased order).
No confirmation gate, no draft store, no ToolDefinition exist yet. This
module is validated here via direct calls / tests only — see
tests/test_gmail_draft_adapter.py.
"""
