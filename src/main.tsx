...
import { initRickyBridge } from "./lib/rickyBridge";
import "./i18n";
import "./styles.css";
...
// CR-2: kreiraj window.ricky preko QWebChannel-a (PySide6 host) ili mock (dev)
// PRIJE render-a, jer App čita window.ricky pri mount-u.
void initRickyBridge().finally(() => {
