...
This project is indexed by GitNexus as **nas_agent** (4027 symbols, 6314 relationships, 128 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
