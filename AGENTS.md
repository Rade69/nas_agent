...
This project is indexed by GitNexus as **nas_agent** (4975 symbols, 7574 relationships, 134 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
