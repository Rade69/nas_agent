...
This project is indexed by GitNexus as **nas_agent** (3964 symbols, 6215 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
