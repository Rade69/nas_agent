...
This project is indexed by GitNexus as **nas_agent** (5245 symbols, 7972 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
