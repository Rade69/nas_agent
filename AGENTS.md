...
This project is indexed by GitNexus as **nas_agent** (2888 symbols, 4765 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
