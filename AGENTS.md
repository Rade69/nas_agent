...
This project is indexed by GitNexus as **nas_agent** (4362 symbols, 6727 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
