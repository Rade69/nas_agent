...
This project is indexed by GitNexus as **nas_agent** (1146 symbols, 1628 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
